...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://oauth.vk.com/authorize?client_id=" + "51883839" + "&redirect_uri=https://oauth.vk.com/blank.html&scope=friends,groups,photos&display=mobile&response_type=token")
